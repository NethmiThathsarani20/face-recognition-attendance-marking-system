...
from test_config import create_test_image, setup_test_database, cleanup_test_data
...
class TestIntegration(unittest.TestCase):
    ...
    def test_full_attendance_workflow(self, mock_listdir, mock_exists, mock_imread, mock_face_analysis):
        ...
        mock_face = MagicMock()
        mock_face.normed_embedding = np.array([0.5] * 512)  # Fixed embedding for consistency
    ...
    def test_config_integration(self, mock_face_analysis):
        ...
        from src.config import (
            FACE_MODEL_NAME, DETECTION_SIZE, SIMILARITY_THRESHOLD,
            WEB_HOST, WEB_PORT, DATABASE_DIR, EMBEDDINGS_DIR, ATTENDANCE_DIR
        )
