...
### Source Files
All performance visualization figures are generated during model training by the `src/embedding_trainer.py` script and saved to the `embedding_models/` directory.
...
2. **`scripts/copy_results_figures.py`**
   ...
   - Preserves other PNG figures as-is
